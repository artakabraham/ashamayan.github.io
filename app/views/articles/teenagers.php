         ...
         <div id="content" class="clearfix">
            ...
            <article id="post-122" class="post-122 post type-post status-publish format-standard has-post-thumbnail hentry category-featured category-nature tag-beach tag-forest tag-ocean">
               <header class="entry-header">
                  <h2 class="entry-title"> <a href="/teenagers/<?=$newsItem['id']?>" title="<?=$newsItem['author']?>"><?=$newsItem['title']?></a></h2>
               </header>
               <figure class="post-featured-image">
                  <a href="/teenagers/<?=$newsItem['id']?>" title="<?=$newsItem['title']?>">
                     <img width="720" height="300" src="<?=Articles::getImage($newsItem['id'],'teenagers');?>" class="attachment-featured-blog-large size-featured-blog-large wp-post-image" alt="<?=$newsItem['title']?>" title="<?=$newsItem['title']?>" />
                  </a>
               </figure>
               <div class="entry-content clearfix">
                  <div class="entry-meta"><span class="sep">
                     ...
                     <span class="tag-links"><i class="fa fa-tags"></i>
                         <a href="" rel="tag">beach</a>,
                         <a href="" rel="tag">forest</a>,
                         <a href="" rel="tag">ocean</a>
                     </span>
                  </div>
                  <p><?=$newsItem['descript']?>...<a href="/teenagers/<?=$newsItem['id']?>" class="more-link">
