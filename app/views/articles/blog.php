                ...
                <div id="content" class="clearfix">
                    ...
                    <article id="post-122" class="post-122 post type-post status-publish format-standard has-post-thumbnail hentry category-featured category-nature tag-beach tag-forest tag-ocean">
                        <header class="entry-header">
                            <h2 class="entry-title"> <a href="/blog/<?=$newsItem['id']?>" title="<?=$newsItem['author']?>"><?=$newsItem['title']?></a></h2>
                        </header>
                        <figure class="post-featured-image">
                            <a href="/blog/<?=$newsItem['id']?>" title="<?=$newsItem['title']?>"><img width="720" height="300" src="<?=Articles::getImage($newsItem['id'],'article');?>" class="attachment-featured-blog-large size-featured-blog-large wp-post-image" alt="<?=$newsItem['title']?>" title="<?=$newsItem['title']?>" /></a>
                        </figure>
                        <div class="entry-content clearfix">
                            ...
                            <p><?=$newsItem[ 'descript']?>...
                               <a href="/blog/<?=$newsItem['id']?>" class="more-link"><span>Читать далее</span></a>
                            </p>
                        </div>
                    </article>
                    <?php endforeach; ?>
