         ...
         <div id="content" class="clearfix">
            ...
            <article id="post-122" class="post-122 post type-post status-publish format-standard has-post-thumbnail hentry category-featured category-nature tag-beach tag-forest tag-ocean">
               <header class="entry-header">
                   <h2 class="entry-title"> <a href="/<?=$newsItem['type']?>/<?=$newsItem['id']?>" title="<?=$newsItem['title']?>"><?=$newsItem['title']?></a></h2>
               </header>
               <figure class="post-featured-image">
                  <a href="/<?=$newsItem['type']?>/<?=$newsItem['id']?>" title="<?=$newsItem['title']?>">
               ...
               <div class="entry-content clearfix">
                  ...
                  <p>
                     <?=$newsItem[ 'descript']?>...
                     <a href="/<?=$newsItem['type']?>/<?=$newsItem['id']?>" class="more-link">
      ...
      <div id="secondary">
         <aside id="recent-posts-2" class="widget widget_recent_entries">
            ...
            <ul>
               ...
               <li>
                  <a href="/<?=$newsItem['type']?>/<?=$article['id']?>">
                  <?=$article[ 'title'];?>
                  </a>
               </li>
               <?php endforeach;?>
